...
$german = array(
	...
	'facebook_connect:post_headder' => 'Wenn Sie aktiviert haben , um auf Benutzer Wand etwas posten zu konfigurieren Sie die folgenden Parameter . Wenn Sie den Namen des Benutzers oder Ort Name dann verwenden möchten verwenden Sie einfach %username% oder %sitename% in das Feld eingeben . Ex: %username% nur synchronisiert sein/ihr Facebook-Konto mit %sitename%',
	'facebook_connect:post_message' => 'Geben Sie Ihre Nachricht, auf die sie Benutzer Wand etwas posten zu wollen <i> (Standard: XYZ nur synchronisiert sein/ihr Facebook-Konto mit %s ) </ i>',
	'facebook_connect:post_img' => 'Geben Sie die Bild-URL, auf die sie den Benutzer senden Sie hinzufügen möchten <i> (Standard: %s_graphics/elgg_logo.png ) </ i>',
	'facebook_connect:post_descp' => 'Geben Sie die Beschreibung auf die sie Benutzerpost<i> (Standard. : %s ist das soziale Netzwerk für die Verbindung von Menschen ) hinzugefügt werden soll </ i>',
